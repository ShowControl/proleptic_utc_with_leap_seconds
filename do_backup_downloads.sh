# File: do_downloads.sh, author: John Sauter, date: October 16, 2025.
#
# Download data files from the IERS using the backup location.
...
cp -p 6_BULLETIN_A_V2013_016.txt ser7.dat
...
cp -p 16_BULLETIN_C16.txt bulletinc.dat
